  ...
  <?php
      ...
      foreach ($rider as &$rider_value) {
        if ($rider_value->rider_photo) {
            ...
            echo get_avatar($rider_value->wp_user_id,200,'','', array('extra_attr'=>'style="border-radius: 0.5rem !important;"','extra_attr'=>'style="padding: 10px !important;"','extra_attr'=>'style="box-shadow: 0 0 10px rgba(0,0,0,0.5);"') );                
        }
